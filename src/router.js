...
import { initBlogPost } from './blog-post.js'

// Export icons for use in other modules
export const icons = {
  shield: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 13c0 5-3.5 7.5-7.5 7.5S5 18 5 13V6l7.5-3L20 6v7z"/><path d="m9 12 2 2 4-4"/></svg>',
...
export function router() {
  ...
  switch (path) {
    case '/blog':
      initBlog()
      break
    case '/blog/ransomware-trends-2025':
      initBlogPost()
      break
    default:
      // Load main page content (already in main.js)
      break
  }
}
